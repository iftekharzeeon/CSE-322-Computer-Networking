...
plt.savefig(graph_type + " vs Throughtput"+".jpg")
...
plt.savefig(graph_type + " vs Average Delay"+".jpg")
...
plt.savefig(graph_type + " vs Packet Delivery Ratio"+".jpg")
...
plt.savefig(graph_type + " vs Packet Drop Ratio"+".jpg")
